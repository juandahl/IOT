  ...
  return (
    <div id="wrapper" className="content">
      <Navbar fluid={true}  style={ {margin: 0} }>
          <Brand>
            <span>
              <img src={logo} alt="Start React" title="LOGEMENT ECO-RESPONSABLE" />
              <span>&nbsp;Logement eco-responsable - </span>
                <a href="https://www.sorbonne-universite.fr/" title="Sorbonne Universite" rel="home">Sorbonne Universite</a>
