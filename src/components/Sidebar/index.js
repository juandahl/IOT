          ...
          <ul className="nav in" id="side-menu">
            ...
            <li>
              <a href="" onClick={(e) => { e.preventDefault(); history.push('/'); }} >
                <i className="fa fa-dashboard fa-fw" /> &nbsp;Tableau de Bord
              </a>
            </li>
            ...
            <li className={classNames({ active: !this.state.chartsElementsCollapsed })}>
              ...
              >
                <i className="fa fa-bar-chart-o fa-fw" /> &nbsp;Consommation
            ...
            <li>
              <a href="" onClick={(e) => { e.preventDefault(); history.push('/table'); }} >
                <i className="fa fa-table fa-fw" /> &nbsp;Etat des capteurs/actionneurs
              </a>
            </li>
